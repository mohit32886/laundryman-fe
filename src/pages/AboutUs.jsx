    ...
    <>
      ...
      <section className="bg-gradient-to-r from-[#1879a2] to-[#145e7d] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Get to know Laundryman - Your trusted laundry and dry-cleaning partner
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              {[
                'Laundryman is a professional laundry and dry-cleaning service operating in Ranchi, Jharkhand. We provide comprehensive cleaning solutions including pickup & delivery services, expert fabric care, and specialized B2B laundry services for businesses.',
                'Our commitment to quality and customer satisfaction has made us a trusted name in the laundry and dry-cleaning industry. We combine state-of-the-art machinery with eco-friendly cleaning solutions to deliver impeccable results every time.',
            ...
            <div className="space-y-8">
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <span className="font-mono">UDYAM-JH-20-0030562</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <div className="text-gray-700">
                  <p className="mb-2">
                    <svg className="w-5 h-5 inline-block mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <a
                  ...
                  download
                  className={`inline-flex items-center ${bgColor('primary')} text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#145e7d] transition-colors`}
                  onClick={(e) => {
                    e.preventDefault()
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <motion.div 
                  className={`${bgColor('bgLight')} w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4`}
                  style={{ color: '#1879a2' }}
      ...
      {/* CTA Section */}
      <section className={`py-16 ${bgColor('primary')} text-white`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h2 
