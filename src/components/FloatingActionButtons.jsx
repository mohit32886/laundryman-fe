...
export default function FloatingActionButtons() {
  ...
  const handleCallClick = () => {
    window.location.href = contactInfo.getTelUrl()
  }
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-lg hover:shadow-xl flex items-center justify-center w-14 h-14"
