      ...
      <AnimatePresence>
        {isCertificateModalOpen && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className="bg-gradient-to-r from-[#1879a2] to-[#24bcee] p-6 rounded-t-2xl">
                ...
                {!isFormSubmitted ? (
                  <form onSubmit={handleCertificateFormSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-[#1879a2] to-[#24bcee] text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
                    >
                      {isSubmitting ? (
                        <>
                  ...
                  <div className="text-center py-6">
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#1879a2] to-[#24bcee] text-white rounded-lg font-semibold hover:shadow-lg transition-all"
                    >
